...
export const RECIPES: Recipe[] = [
  ...
  { id: "chainmail", name: "Cota de malla", kind: "armor", gear: FORGE_ARMOR.find((g) => g.id === "chainmail"), gold: 180, note: "armadura pesada", materials: [{ id: "mace", name: "Maza", qty: 2 }] },
  { id: "plate", name: "Coraza de placas", kind: "armor", gear: FORGE_ARMOR.find((g) => g.id === "plate"), gold: 260, note: "la mejor defensa", materials: [{ id: "sabre", name: "Sable", qty: 3 }] },
];
