...
export const DUNGEON_TYPES: DungeonType[] = [
  { id: "cripta",     name: "Cripta olvidada",      short: "Cripta",     desc: "Pasillos de piedra tomados por los no-muertos.",        kinds: ["undead"],                     biome: "cripta" },
  { id: "madriguera", name: "Madriguera infestada", short: "Madriguera", desc: "Túneles de tierra donde pululan las alimañas.",         kinds: ["rodent"],                     biome: "madriguera" },
  { id: "guarida",    name: "Guarida salvaje",      short: "Guarida",    desc: "Cuevas húmedas donde acechan las bestias.",             kinds: ["beast"],                      biome: "cueva" },
  { id: "ruinas",     name: "Ruinas profundas",     short: "Ruinas",     desc: "Ruinas antiguas donde se mezclan todas las amenazas.",  kinds: ["undead", "rodent", "beast"],  biome: "ruinas" },
];
